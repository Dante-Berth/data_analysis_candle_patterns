...
async def _download(exchange_names, symbols, timeframe, dir, since: datetime.datetime,
...
async def main():
    await _download(
        ["binance"],
        symbols=["EUR/USDT","BTC/USDT","ETH/USDT"],
        timeframe="5m",
        dir="../data",
        since=datetime.datetime(year=2018, month=4, day=1),
    )
